      ...
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        ...
        <div class="card">
          ...
          <ul class="list-group list-group-horizontal mt-1" style="list-style-type: none; border: 0">
            ...
            <span>
                <p class="text-success" style="margin-left: 15px">View all {{$post->comment_count}} comments</p>

            <div class="d-flex align-items-center card-body" style="margin-top: -15px">
                <img src="#" class="mr-2" style="width: 35px; height: 35px; border-radius: 50%" />

              <p class="my-auto card-text postuserfont">
        ...
        <div class="card mt-5 mb-3">
          <div class="card-header">
            <img src="https://a.storyblok.com/f/191576/1200x800/faa88c639f/round_profil_picture_before_.webp" class="mr-2" style="width: 35px; height: 35px; border-radius: 50%" />
          ...
          <p style="margin-left: 5px"><b>this is my first post</b></p>
          <ul class="list-group list-group-horizontal mt-1" style="list-style-type: none; border: 0">
            <li class="nav-item">
              <a class="nav-link" href="#"><i class="far fa-heart fa-lg" style="color: black; position: relative; font-size: 23px"></i></a>
            </li>
          ...
          <p style="margin-left: 15px" > <b  >17 Likes</b></p>

          <span>
            <p class="text-success" style="margin-left: 15px ">View all 5 comments</p>
            <div class="d-flex align-items-center card-body" style="margin-top: -15px">
                <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHByb2ZpbGUlMjBwaG90b3xlbnwwfHwwfHx8MA%3D%3D" class="mr-2" style="width: 35px; height: 35px; border-radius: 50%" />
