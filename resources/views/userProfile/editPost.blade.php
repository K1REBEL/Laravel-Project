...
{{--            <input type="file" id="images" name="images[]" style="display: none" multiple value="{{$existingMedia}}">--}}

            <input type="file" id="images" name="images[]" style="display: none" multiple>
            @if($existingMedia->isNotEmpty())
            <div id="imagePreviews" class="slider">
                @foreach($existingMedia as $media)
                        <img src="{{ asset('storage/' . $media->url) }}" alt="Existing Media">
                @endforeach
            </div>
            @endif
            ...
            <textarea id="caption" name="caption" rows="4" >{{$posts->caption}}</textarea>

            <label for="hashtag">hashtag</label>
            <input type="text" id="hashtag" name="hashtag" value="{{$posts->hashtag}}">
